...
var BG_OVERLAY    = 'rgba(6,4,0,0.88), rgba(14,10,0,0.90)';
...
+'@media(max-width:768px){body{background:linear-gradient(135deg,'+BG_OVERLAY+'),url("https://i.postimg.cc/4NFSBCKn/BG-MOBILE-KUATBET.png") center/cover fixed no-repeat #000;}}\n'
+'#kuatbet-root{background:linear-gradient(135deg,'+BG_OVERLAY+'),url("'+BG_IMAGE+'") center/cover fixed no-repeat #000;padding:1px 0;border-radius:0;min-height:100px;}\n'
