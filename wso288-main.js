...
var SITE_LOGO     = 'https://api2-ws2.imgzm.com/images/jqjfjpoen4u/logo_5a9093ad-d5f7-48ac-a12b-43f042867fe5_1780189530370.png';
...
function showLoading(msg, pct){
  ...
  root.innerHTML =
    ...
    '<img src="https://api2-ws2.imgzm.com/images/jqjfjpoen4u/logo_5a9093ad-d5f7-48ac-a12b-43f042867fe5_1780189530370.png" alt="WSO288" style="width:110px;max-height:72px;object-fit:contain;filter:drop-shadow(0 0 16px #5DC820);margin-bottom:8px;"/>'+
...
+'#wso288-root{background:linear-gradient(135deg,'+BG_OVERLAY+'),url("'+BG_IMAGE+'") center/cover fixed no-repeat #000;padding:1px 0;border-radius:0;min-height:100px;}\n'
