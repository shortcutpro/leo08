...
+'@media(max-width:768px){body{background:linear-gradient(135deg,'+BG_OVERLAY+'),url("https://i.postimg.cc/TYH4C8yY/BG-MOBILE-WSO288.png") center/cover fixed no-repeat #000;}}\n'
